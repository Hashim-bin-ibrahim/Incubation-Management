                          ...
                          {obj.status === true ? (
                            <div>
                              ...
                              <div className="bookedIcon">
                                <img style={{height:100}} src="https://img.icons8.com/material/344/lock--v1.png" onClick={() => {
                            ...
                            (<div className="">
                              ...
                              <img style={{height:100}} src=" https://img.icons8.com/material-outlined/344/open-lock.png" 
                              onClick={async () => {
